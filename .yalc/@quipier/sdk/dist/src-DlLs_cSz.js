			...
			/* @__PURE__ */ Q("div", {
				...
				children: [/* @__PURE__ */ Q("strong", {
					...
					children: [/* @__PURE__ */ Q("button", {
						...
						"aria-haspopup": "menu",
						"aria-expanded": h,
						children: [/* @__PURE__ */ Q(Xe, {}), /* @__PURE__ */ Q("span", { children: "정렬 기준" })]
					}), h ? /* @__PURE__ */ Q("div", {
...
function $e() {
	...
	e.setAttribute("data-quipier", ""), e.textContent = Ze, document.head.appendChild(e);
}
//#endregion
//#region src/index.ts
var et = "https://api.quipier.com", tt = "https://passport.quipier.com";
function nt(e) {
	return typeof e == "string" ? document.querySelector(e) : e;
}
function rt(e) {
	let t = nt(e.container);
	...
	let i = e.pageId ?? t.dataset.quipierPageId ?? window.location.pathname, a = e.apiBase ?? et, o = e.passportAppOrigin ?? e.walletAppOrigin ?? t.dataset.quipierPassportApp ?? t.dataset.quipierWalletApp ?? tt, s = e.theme ?? t.dataset.quipierTheme ?? "light", c = e.dateFormat ?? "relative", l = e.maxDepth ?? 2, u = e.sort ?? "top";
	$e(), ae(null, t), ae(b(Je, {
		apiBase: a,
		apiKey: n,
		projectId: r,
...
//#endregion
export { rt as n, it as t };

//# sourceMappingURL=src-DlLs_cSz.js.map