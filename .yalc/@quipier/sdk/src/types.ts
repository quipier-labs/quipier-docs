// HTTP wire-format types — kept in sync with the Quipier API (/v1) by integration tests.
// Inlined (not pulled from @quipier/shared) so the SDK can be published with zero internal deps.
