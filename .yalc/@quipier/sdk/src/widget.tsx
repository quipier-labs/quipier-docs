...
export function Widget(props: WidgetProps) {
  ...
  return (
    <div class="quipier-root" data-quipier-theme={props.theme ?? "light"}>
      <div class="quipier-header">
        <strong class="quipier-count">댓글 {visibleCount}개</strong>
        <div class="quipier-sort">
          <button
      ...
      {loading ? (
        ...
        <div class="quipier-empty">아직 댓글이 없어요. 가장 먼저 남겨보세요.</div>
      ) : (
        <div class="quipier-list">
          {tree.map((node) => (
            <CommentItem
              key={node.comment.id}
              node={node}
